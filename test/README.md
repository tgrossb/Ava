...
<h4><a name="tool-cfg-hf"></a>header/footer <span sytle="font-weight:normal">[`color` ([bash color](#bash-colors)), `bold` (boolean)]</span></h4>
...
<h4><a name="tool-cfg-cmd"></a>command <span style="font-weight:normal">[`color` ([bash color](#bash-colors)), `bold` (boolean)]</span></h4>
...
<h4><a name="tool-cfg-cmd-out"></a>command output <span style="font-weight:normal">[`color` ([bash color](#bash-colors)), `bold` (boolean)]</span></h4>
...
<h4><a name="tool-cfg-warn"></a>warning <span style="font-weight:normal">[`color` ([bash color](#bash-colors)), `bold` (boolean)]</span></h4>
...
<h4><a name="tool-cfg-bwarn"></a>background Warning <span style="font-weight:normal">[`color` ([bash color](#bash-colors)), `bold` (boolean)]</span></h4>
...
<h4><a name="tool-cfg-err"></a>error <span style="font-weight:normal">[`color` ([bash color](#bash-colors)), `bold` (boolean)]</span></h4>
...
<h4><a name="tool-cfg-affirm"></a>affirmation <span style="font-weight:normal">[`color` ([bash color](#bash-colors)), `bold` (boolean)]</span></h4>
...
<h4><a name="tool-cfg-lineh"></a>line header <span style="font-weight:normal">[`color` ([bash color](#bash-colors)), `bold` (boolean)]</span></h4>
...
<h4><a name="tool-cfg-stdout"></a>standard Output <span style="font-weight:normal">[`color` ([bash color](#bash-colors)), `bold` (boolean)]</span></h4>
...
<h4><a name="tool-cfg-log-name"></a>log file name <span style="font-weight:normal">[`name` (string)]</span></h4>
...
<h4><a name="tool-cfg-log-type"></a>logging type <span style="font-weight:normal">[`project logging` (boolean), `individual logging` (boolean)]</span></h4>
...
<h4><a name="tool-cfg-proj-cfg-name"></a>project configuration file <span style="font-weight:normal">[`name` (string)]</span></h4>
