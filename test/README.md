...
1. [Tool configuration file](#tool-configuration-file)
	1.1 [What is it](#tool-configuration-file#what-is-it)
		1.1.1 [Header/footer](#tool-configuration-file#what-is-it#header-footer)
		1.1.2 [Command](#tool-configuration-file#what-is-it#command)
		1.1.3 [Command output](#tool-configuration-file#what-is-it#command-output)
		1.1.4 [Warning](#tool-configuration-file#what-is-it#warning)
		1.1.5 [Background Warning](#tool-configuration-file#what-is-it#background-warning)
		1.1.6 [Error](#tool-configuration-file#what-is-it#error)
		1.1.7 [Affirmation](#tool-configuration-file#what-is-it#affirmation)
		1.1.8 [Line header](#tool-configuration-file#what-is-it#line-header)
		1.1.9 [Standard Output](#tool-configuration-file#what-is-it#standard-output)
		1.1.10 [Log file name](#tool-configuration-file#what-is-it#log-file-name)
		1.1.11 [Logging type](#tool-configuration-file#what-is-it#logging-type)
		1.1.12 [Project configuration file](#tool-configuration-file#what-is-it#project-configuration-file)
